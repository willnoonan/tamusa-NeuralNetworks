...
class CIFAR100_Test:
    ...
    def run(self):
        print(self)
        model = NeuralNet(self.nn_stack).to(self.device)
...
Best exp
"""
expBest = CIFAR100_Test(input_size=INPUT_SIZE, nn_stack=linear_layer_stack_1, epochs=2, optimizer_func=torch.optim.Adam,
                     loss_func=nn.CrossEntropyLoss, learning_rate=0.0001)