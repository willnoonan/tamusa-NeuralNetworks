...
class CIFAR100_Test:
    ...
    def run(self):
        ...
        model = copy.deepcopy(self.model)  # must a deep copy to cut refs
...
"""
expBest = CIFAR100_Test(input_size=INPUT_SIZE, nn_stack=linear_layer_stack_1b, epochs=100, optimizer_func=torch.optim.Adam,
                     loss_func=nn.CrossEntropyLoss, learning_rate=0.0001)
