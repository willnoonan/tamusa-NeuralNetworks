...
def lin_reg_gd(X, Y, learning_rate=1, epochs=1000):
    """
...
# Grab 3rd column for this demo
X_fi = X[:, 1]  # X feature i
...
ax2.plot(diabetes_X, diabetes_y_pred, color="blue", linewidth=3)
